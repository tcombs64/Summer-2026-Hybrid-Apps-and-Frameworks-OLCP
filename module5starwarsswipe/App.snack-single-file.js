// Module 5 — Star Wars app: ScrollView + Swipeable (single-file Snack version)
//
...
// ---- Swipeable list row (Chapter 24) ----
function SwipeableRow({ label, onSwipe }) {
  ...
  return (
    <View style={[styles.swipeContainer, { width: rowWidth }]}>
      <ScrollView
        ref={scrollViewRef}
        horizontal
        pagingEnabled
