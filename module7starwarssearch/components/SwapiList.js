...
// just under the header image. Earlier modules popped up a dialog to search;
// now typing filters the shown list live — the list re-renders on every
// keystroke to show only the items whose name contains what was typed.
