// Star Wars app: Search (single-file Snack version)
//
...
//
// - NEW (Module 7, "Search"): a search box sits at the top of every screen,
//   just under the header image. Earlier modules popped up a dialog to
//   search; now typing filters the shown list live — the list re-renders on
//   every keystroke to show only the items whose name contains the text.
